...
public class ChatServerList {
	...
	public boolean register(String ID, ChatServer chatserver){                      //Adds the new user to the user list 
	...
	public void submit(Message message, String ID){                                //Passes the message to the reciever's socket
